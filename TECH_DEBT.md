...
4. ~~HTML injection in every email template via raw f-string interpolation~~ ([2.3](#23-notifications--email)). **(DONE: B7)**
...
- **P0 (blocks launch):** 14 findings. **All 14 closed across batches B1–B8.**
