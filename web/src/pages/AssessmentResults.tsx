          ...
          <div className="grid grid-cols-2 gap-3 mt-16 no-print sm:flex sm:flex-wrap sm:items-center">
            ...
            {assessmentId && (
              <button
                ...
                disabled={pdfLoading}
                className="h-[50px] px-5 sm:px-8 bg-white border-2 border-brand-teal text-brand-teal font-body font-bold text-base sm:text-lg rounded-xl hover:bg-brand-teal/10 transition-colors disabled:opacity-50 flex items-center justify-center whitespace-nowrap w-full sm:w-auto col-span-2 order-3 sm:order-none"
              >
