            ...
            <div className="flex flex-wrap items-center gap-3">
              {assessmentId && (
                <button
                  ...
                  disabled={pdfLoading}
                  className="h-[50px] px-5 sm:px-8 bg-white border-2 border-brand-teal text-brand-teal font-body font-bold text-base sm:text-lg rounded-xl hover:bg-brand-teal/10 transition-colors disabled:opacity-50 whitespace-nowrap"
                >
